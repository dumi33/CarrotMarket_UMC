...
## 핵심적인 기능을 위해 필요한 DB 설계 & API를 구현



# <spring 이용>

<연합 개발 동아리 UMC의 서버 교육용 템플릿을 이용하였습니다.>
...
## ✨License
- 본 템플릿의 소유권은 소프트스퀘어드에 있습니다. 본 자료에 대한 상업적 이용 및 무단 복제, 배포 및 변경을 원칙적으로 금지하며 이를 위반할 때에는 형사처벌을 받을수 있습니다.
